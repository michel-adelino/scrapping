...
def test_all_scrapers():
    ...
    scrapers_to_test = [
        ...
        ("SPIN NYC - Flatiron", lambda: spin.scrape_spin(TEST_GUESTS, TEST_DATE, location='flatiron')),
        ("SPIN NYC - Midtown", lambda: spin.scrape_spin(TEST_GUESTS, TEST_DATE, location='midtown')),
...
def test_single_scraper(scraper_name):
    ...
    scraper_map = {
        ...
        'spin_nyc_flatiron': ('SPIN NYC - Flatiron', lambda: spin.scrape_spin(TEST_GUESTS, TEST_DATE, location='flatiron')),
        'spin_nyc_midtown': ('SPIN NYC - Midtown', lambda: spin.scrape_spin(TEST_GUESTS, TEST_DATE, location='midtown')),
