...
const VENUE_IMAGE_MAP = {
  ...
  'The Lawn Club (Indoor Gaming)': 'LawnClub.webp',
  'The Lawn Club (Curling Lawns)': 'LawnClubCurlingNewYork.jpg',
  'The Lawn Club (Croquet Lawns)': 'LawnClubCroquetNewYork.webp',
